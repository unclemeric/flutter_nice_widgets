...
import 'package:flutter_nice_widgets/widgets/browser.dart';
...
class WebviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    WebViewController controller = getWebviewController('https://www.baidu.com/');
    controller.addJavaScriptChannel('TakePhoto', onMessageReceived: (JavaScriptMessage message) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          // SampleMenu(webViewController: controller),
        ],
      ),
